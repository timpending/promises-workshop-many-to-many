...
exports.seed = function(knex, Promise) {
  return Promise.join(
    knex('books').del(),
    knex('books').insert({id: 401, title: "Python In A Nutshell", genre: "Python", description: description_1, cover_url: url_1 }),
    knex('books').insert({id: 402, title: "Think Python", genre: "Python", description: description_2, cover_url: url_2 }),
    knex('books').insert({id: 403, title: "Learning React Native", genre: "JavaScript", description: description_3, cover_url: url_3 }),
    knex('books').insert({id: 404, title: "You Don't Know JS: ES6 & Beyond", genre: "JavaScript", description: description_4, cover_url: url_4 }),
    knex('books').insert({id: 405, title: "You Don't Know JS: Scope & Closures", genre: "JavaScript", description: description_5, cover_url: url_5 }),
    knex('books').insert({id: 406, title: "You Don't Know JS: Async & Performance", genre: "JavaScript", description: description_6, cover_url: url_6 })
